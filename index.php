...
<body>
    ...
    <section id="Sobre-Mi" class="pt-5 container ">
        ...
        <div>
            <p class="text-center">Trabajando en el área de la informática con más de 8 años de experiencia en el ámbito
                de Soporte TI.
                Mi perspectiva profesional es crecer en el ámbito de programación en base a los lenguajes que domino.
                Android y Python me motivan para seguir desarrollándome en nuevos desafíos en área de la informática.
            </p>
        </div>
    ...
    <section id="Trabajos" class="py-5">
        <div class="container">
            <h1 class="fw-bold text-center text-white text-uppercase mt-2">MIS ÚLTIMOS TRABAJOS</h1>
                ...
                <div class="col-sm-4 my-3">
                    <div class="card border-0" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text fw-light">Página web información de una pasteleria.
